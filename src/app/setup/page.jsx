    ...
    <div className="layout">
      <div className="card">
        ...
        <div className="form-row">
          ...
          <button className="btn-small" onClick={addDaily}>Add</button>
        </div>
        ...
        <div className="form-row">
          ...
          <button className="btn-small" onClick={addWeekly}>Add</button>
        </div>
      ...
      {/* EDIT MODAL */}
      {editItem && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.6)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }} onClick={() => setEditItem(null)}>
          <div className="card" style={{ minWidth: 320, maxWidth: 420 }} onClick={e => e.stopPropagation()}>
